# -*- coding: utf-8 -*-
"""
Created on Sat Oct  1 14:05:09 2022
...
data_feed = GetData()
df, X_train1, X_test1, Y_train1, Y_test1, scaler1, WINDOWSIZE = data_feed.get_seq_data()
...
# # NN_model = Sequential()
# # NN_model.add(Dense(512, input_dim=X_train2.shape[1])) #12
...
# # NN_model.fit(np.array(X_train2), np.array(Y_train2), verbose=2, epochs=8)
...
#     LSTM(512, input_shape=(X_train1.shape[1], X_train1.shape[2]), return_sequences=True),
#     Dropout(0.2),
...
LSTM_model = keras.Sequential([
    LSTM(128, input_shape=(X_train1.shape[1], X_train1.shape[2]), return_sequences=True, dropout=0.2),
...
# X = scaled_meta_input[:, 0:3]
# Y = scaled_meta_input[:, 3]
